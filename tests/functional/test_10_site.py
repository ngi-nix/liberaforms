...
class TestSiteConfig():
    ...
    def test_change_sitename(cls, site, users, client, anon_client):
    ...
    def test_change_default_language(cls, site, users, client, anon_client):
    ...
    def test_toggle_invitation_only(cls, site, users, client, anon_client):
    ...
    def test_change_primary_color(cls, site, users, client, anon_client):
    ...
    def test_change_logo(self, app, users, client, anon_client):
    ...
    def test_restore_default_logo(self, app, users, client, anon_client):
    ...
    def test_toggle_newuser_enableuploads(self, users, site, client, anon_client):
        """ Tests permissions
            Tests toggle
        """
    ...
    def test_edit_public_link_creation(self, users, site, client, anon_client):
    ...
    def test_edit_blurb(self, users, site, client, anon_client):
    ...
    def test_save_smtp_config(self, users, site, client):
